...
public class falit extends Activity {
       ...
       // if( Public_veriable.registered==0){tf = Typeface.DEFAULT;}
        ...
        if(Public_veriable.FalT==1){
            ...
            if ( cursor.moveToFirst () ) {
                do {
                    fcode = cursor.getString(0);
                    if (fcode.equals(Public_veriable.BDNUM+"") || fcode.equals("0"+Public_veriable.BDNUM)){
        ...
        if(Public_veriable.FalT==3){
            if(Public_veriable.FEN==1){
                if ( cursor.moveToFirst () ) {
                    do {
                        fcode = cursor.getString(0);
                        if (fcode.equals("Y"+Public_veriable.BDNUM)||fcode.equals("Y0"+Public_veriable.BDNUM)){
